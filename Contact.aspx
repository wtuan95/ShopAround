        ...
        <div id="wrapper" >
                <fieldset>
                    ...
                    <div>
                        ...
                        <asp:RequiredFieldValidator ValidationGroup="validationContact" ID="RequiredFieldtxtHoTen" runat="server" CssClass="redcolor" Display="Dynamic" ErrorMessage="Bạn chưa nhập họ tên" ControlToValidate="txtHoTen">*</asp:RequiredFieldValidator>
                    </div>
                    <div>
                        <input type="text" runat="server" id="txtDiaChi" name="diachi" placeholder="Địa chỉ"/>
                        <asp:RequiredFieldValidator ValidationGroup="validationContact" ID="RequiredFieldtxtDiaChi" runat="server" ErrorMessage="Bạn chưa nhập địa chỉ" ControlToValidate="txtDiaChi" CssClass="redcolor" Display="Dynamic">*</asp:RequiredFieldValidator>
                    </div>
                    <div>
                        <input type="text" runat="server"  id="txtEmail" name="email" placeholder="Email"/>
                        <asp:RequiredFieldValidator ValidationGroup="validationContact"  ID="RequiredFieldtxtEmail" runat="server" ErrorMessage="Bạn chưa nhập địa chỉ email" ControlToValidate="txtEmail" CssClass="redcolor" Display="Dynamic">*</asp:RequiredFieldValidator>
                        <br />
                        <asp:RegularExpressionValidator ValidationGroup="validationContact" ID="RegularExpressiontxtEmail" runat="server" ErrorMessage="Địa chỉ email không hợp lệ." ControlToValidate="txtEmail" CssClass="redcolor" Display="Dynamic" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*">*</asp:RegularExpressionValidator>
                    </div>
                    <div>
                        ...
                        <br />
                        <asp:ValidationSummary ID="ValidationSummary1" runat="server" ForeColor="Red" HeaderText="Lỗi:" ValidationGroup="validationContact" />
                        <br />
                    </div>   
                    <div>
